...
public class TpMyCommand implements CommandExecutor, TabCompleter {
    ...
    public TpMyCommand(Realms plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (type) {
            ...
            case "empire": {
                ...
                me.marcdoesntexists.realms.societies.Empire empire = societies.getEmpire(empireName);
                if (empire == null) {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        if (args.length == 1) {
            return me.marcdoesntexists.realms.utils.TabCompletionUtils.match(Arrays.asList("town", "kingdom", "empire"), args[0]);
        }
