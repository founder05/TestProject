...
import me.marcdoesntexists.realms.managers.ChatManager;
import me.marcdoesntexists.realms.managers.ChatManager.Channel;
...
public class ChannelCommand implements CommandExecutor, TabCompleter {
    ...
    public ChannelCommand(Realms plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("spy")) {
            if (!player.hasPermission("realms.chat.spy")) {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        if (args.length == 1) {
            return me.marcdoesntexists.realms.utils.TabCompletionUtils.match(
