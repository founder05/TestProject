...
public class SocietiesManager {
    ...
    public void registerEmpire(Empire empire) {
    ...
    public void removeEmpire(String name) {
        empires.remove(name);
    }
    ...
    public void registerTreaty(Treaty treaty) {
        treaties.put(treaty.getTreatyId(), treaty);
    }

    public Treaty getTreaty(UUID id) {
        return treaties.get(id);
    }

    public void registerFeudalRelationship(FeudalRelationship relationship) {
        feudalRelationships.put(relationship.getRelationshipId(), relationship);
    }

    public FeudalRelationship getFeudalRelationship(UUID id) {
        return feudalRelationships.get(id);
    }

    public Collection<FeudalRelationship> getAllFeudalRelationships() {
        return new ArrayList<>(feudalRelationships.values());
    }
