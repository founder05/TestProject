...
import me.marcdoesntexists.realms.managers.EconomyManager;
...
public class EconomyService {
    ...
    private EconomyService(Realms plugin) {
        this.plugin = plugin;
    ...
    public static EconomyService getInstance(Realms plugin) {
        if (instance == null) {
        ...
        try {
            ...
            for (Player p : Bukkit.getOnlinePlayers()) {
                try {
                    ...
                    if (p.hasPermission("realms.save.exempt")) continue;
